...
if (isset($_POST['btnSubmit'])) {
    ...
    $profile->updateProfile($userId, $fname, $mname, $lname, $gender, $address, $house, $street, $barangay, $city, $country, $zipcode, $email, $cellphone);
}

if (isset($_POST['pictureSubmit'])) {
    $user->updateUserPicture($_SESSION['user']->id, $pictureUtils->setImage($_FILES['file']));
}
                            ...
                            <div class="mdflex">
                                <div class="w-full">
                                    ...
                                    <div class="bg-white ">
                                        ...
                                        <h1 class="text-gray-900 ">Joshua Neo
                                        </h1>
                                        <h3 class="text-gray-600 ">Melaham Chuchu</h3>
                                        ...
                                        <form method="POST" enctype="multipart/form-data">
                                            ...
                                            <h1 class="text-gray-900 ">Edit Profile
                                                <label for="submit" class="file">
                                                    ...
                                                    <input type="submit" id="submit" name="pictureSubmit" value="Update" class="btn-sumbit">
                                                </label>
                                            </h1>
                                        </form>
                                    </div>
                                        ...
                                        <div class="text-gray-700">
                                            <div class="grid ">
                                                ...
                                                <div class="cols">
                                                    ...
                                                    <div class="py-2"><?= $profileDetails->profile_fname; ?></div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Last Name</div>
                                                    <div class="py-2"><?= $profileDetails->profile_lname; ?></div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Gender</div>
                                                    <div class="py-2"><?= $stringUtils->getGender($profileDetails->profile_gender); ?></div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Contact No.</div>
                                                    <div class="py-2"><?= $profileDetails->profile_cellphone; ?></div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Current Address</div>
                                                    <div class="py-2"><?= $profileDetails->profile_fulladdress; ?></div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Email.</div>
                                                    <div class="py-2">
                                                        <a class="text-blue-800" href="#"><?= $profileDetails->profile_email; ?></a>
                                                    </div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Birthday</div>
                                                    <div class="py-2"><?= $profileDetails->profile_birthday; ?></div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Team</div>
                                                    <div class="py-2">
                                                        <a class="text-blue-800" href="#"><?= $team->getTeam($userDetails->team_id)->team_name; ?></a>
                                                    </div>
                                                </div>
                                                <div class="cols">
                                                    <div class="semibold">Department</div>
                                                    <div class="py-2">
                                                        <a class="text-blue-800" href="#"><?= $department->getDepartment($userDetails->department_id)->department_name;  ?></a>
                                                    </div>
                                                </div>
                                                <div class="cols-btn">
                                                ...
                                                <div class="steps">
                                                    <div class="form-steps">
                                                        ...
                                                        <div class="form-group firstname">
                                                            ...
                                                            <input type="text" value="<?= $profileDetails->profile_fname; ?>" name="firstname" id="firstname" placeholder="First Name" autocomplete="off" required>
                                                        ...
                                                        <div class="form-group middlename">
                                                            ...
                                                            <input type="text" value="<?= $profileDetails->profile_mname; ?>" name="middlename" id="middlename" placeholder="Middle Name" autocomplete="off">
                                                            <div data-validation="middlename"></div>
                                                        </div>
                                                        <!-- Last Name -->
                                                        <div class="form-group lastname">
                                                            <label for="lastname">Last Name</label>
                                                            <input type="text" value="<?= $profileDetails->profile_lname; ?>" name="lastname" id="lastname" placeholder="Last Name" autocomplete="off" required>
                                                            <div data-validation="lastname"></div>
                                                        </div>
                                                        <!-- Contact Number -->
                                                        <div class="form-group cNo">
                                                            <label for="contact_number">Contact Number</label>
                                                            <input type="text" value="<?= $profileDetails->profile_cellphone; ?>" name="contact_number" id="contact_number" placeholder="Contact Number" autocomplete="off" required>
                                                        ...
                                                        <div class="form-group email">
                                                            ...
                                                            <input type="email" value="<?= $profileDetails->profile_email; ?>" name="email" id="email" placeholder="Email" autocomplete="off" required>
                                                    ...
                                                    <div class="steps">
                                                        <div class="form-add">
                                                            ...
                                                            <div class="form-group house_no">
                                                                ...
                                                                <input type="text" value="<?= $profileDetails->profile_house; ?>" name="house_no" id="house_no" placeholder="House #" autocomplete="off" required>
                                                                <div data-validation="house_no"></div>
                                                            </div>
                                                            <!-- Street Name -->
                                                            <div class="form-group street_name">
                                                                <label for="street_name">Street Name</label>
                                                                <input type="text" value="<?= $profileDetails->profile_street; ?>" name="street_name" id="street_name" placeholder="Street Name" autocomplete="off" required>
                                                            ...
                                                            <div class="form-group barangay">
                                                                ...
                                                                <input type="text" value="<?= $profileDetails->profile_barangay; ?>" name="barangay" id="barangay" placeholder="Barangay" autocomplete="off" required>
                                                                <div data-validation="barangay"></div>
                                                            </div>
                                                            <!-- Zip Code -->
                                                            <div class="form-group zip">
                                                                <label for="zip">Zip Code</label>
                                                                <input type="text" value="<?= $profileDetails->profile_zipcode; ?>" name="zip" id="zip" placeholder="Zip Code" autocomplete="off" required>
